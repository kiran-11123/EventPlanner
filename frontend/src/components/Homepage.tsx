...
export default function HomePage() {
  ...
  return (
    ...
    <div>
      <header
        className={`fixed top-0 left-0 w-full z-50 bg-white shadow-2xl h-20 rounded-lg px-4 py-2 flex items-center ${admin ? "justify-evenly gap-6" : "justify-between"
          }`}
      >
        <h1 className="hidden sm:block text-white font-mono text-md sm:text-lg font-bold px-4 py-2 shadow-md rounded-md bg-blue-600 hover:bg-blue-800">
          EventNest
        </h1>
